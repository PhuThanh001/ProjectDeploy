...
namespace ProjectParticipantManagement.BAL.Heplers
{
    public static class ErrorHelper
    {
        ...
        public static string GetErrorString(string fieldName, string messageError)
        {
            List<ErrorDetail> errors = new List<ErrorDetail>();
            ...
            ErrorDetail errorDetail = new ErrorDetail()
            {
                ...
                DescriptionError = new List<string> { messageError }
            };
